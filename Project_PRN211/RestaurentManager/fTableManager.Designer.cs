namespace RestaurentManager
{
	partial class fTableManager
	{
		...
		private void InitializeComponent()
		{
			...
			InforAcountToolStripMenuItem = new ToolStripMenuItem();
			...
			// 
			// InforAcountToolStripMenuItem
			// 
			InforAcountToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { PersonalInfoToolStripMenuItem, LogOutToolStripMenuItem });
			InforAcountToolStripMenuItem.Name = "InforAcountToolStripMenuItem";
			InforAcountToolStripMenuItem.Size = new Size(151, 24);
			InforAcountToolStripMenuItem.Text = "Thông tin tài khoản";
			// 
			// PersonalInfoToolStripMenuItem
			// 
			PersonalInfoToolStripMenuItem.Name = "PersonalInfoToolStripMenuItem";
			PersonalInfoToolStripMenuItem.Size = new Size(224, 26);
			PersonalInfoToolStripMenuItem.Text = "Thông tin cá nhân";
			PersonalInfoToolStripMenuItem.Click += PersonalInfoToolStripMenuItem_Click_1;
			// 
			...
			menuStrip1.Items.AddRange(new ToolStripItem[] { adminToolStripMenuItem, InforAcountToolStripMenuItem });
		...
		private ToolStripMenuItem InforAcountToolStripMenuItem;
